...
mysql_query("insert into activity_log (date,username,action) values(NOW(),'$invent_username','Repair Device $dev_name Inventory Code:$dev_serial')")or die(mysql_error());						
