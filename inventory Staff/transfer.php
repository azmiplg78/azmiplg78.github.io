									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
									   ...
									   <div class="control-group">
										...
										mysql_query("insert into activity_log (date,username,action) values(NOW(),'$invent_username','transfer Device  $dev_name to location id $stdev_id')")or die(mysql_error());			
										?>
										<script>
