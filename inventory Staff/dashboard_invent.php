...
<?php  include('session.php'); ?>
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
			 <?php include('dashboard_invent_slidebar.php'); ?>		
                    ...
                    <div class="col-lg-12">
                      <div class="alert alert-success alert-dismissable">
                         <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                          <img id="avatar1" class="img-responsive" src="<?php echo $row['inventthumbnails']; ?>"><strong> Welcome! <?php echo $invent_row['firstname']." ".$invent_row['lastname'];  ?></strong>
                      </div>
                    </div>
