     <div class="span3" id="sidebar">
	             <div class="empty"><img id="admin_avatar" class="img-polaroid" src="<?php echo $row['inventthumbnails']; ?>"></div>
                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                           <li class=""> 
						   <a href="dashboard_invent.php"><i class="icon-chevron-right"></i><i class="icon-home"></i>&nbsp;Dashboard</a> 
