...
<?php include('session.php');?>
            ...
            <div class="row-fluid">
               ...
               <div class="span9" id="content">
                     <div class="row-fluid">
					  ...
					  <div class="alert alert-success"><i class="icon-info-sign"></i> <?php echo $invent_row['firstname']." ".$invent_row['lastname'];  ?> Please Fill in required details</div>
					
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><i class="icon-user"></i>&nbsp;Change Password of <?php echo $invent_row['firstname']." ".$invent_row['lastname'];  ?> </div>							 
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
  								
								<?php
								$query = mysql_query("select * from invent where client_id = '$session_id'")or die(mysql_error());
   ...
   <script>
			...
			jQuery("#change_password").submit(function(e){
					...
					$.ajax({
						type: "POST",
						url: "update_password_invent.php",
						data: formData,
