     <div class="span3" id="sidebar">
	              <div class="empty" >
				   <img id="admin_avatar" class="img-polaroid" src="<?php echo $row['inventthumbnails']; ?>"></div>
					<?php include('count.php'); ?>
					 <?php include('count_damage.php'); ?>
					 <?php include('count_dump.php'); ?>
					 <?php include('count_remain_new_device.php'); ?>
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                         <li> <a href="dashboard_invent.php"><i class="icon-chevron-right"></i><i class="icon-home"></i>&nbsp;Dashboard</a> </li>
						<li class="">		
