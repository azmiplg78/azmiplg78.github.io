...
<head>
					   ...
					   <div class="offset2">
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><i class="icon-user"></i>&nbsp;Change Password of <?php echo $public_row['firstname']." ".$public_row['lastname'];  ?> </div>
								<div class="muted pull-right"><a id="return" data-placement="left" title="Click to Return" href="dashboard_public.php"><i class="icon-arrow-left icon-large"></i> Back</a></div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
  								<div class="alert alert-info"><i class="icon-info-sign"></i> <?php echo $public_row['firstname']." ".$public_row['lastname'];  ?> Please Fill in required details</div>
								<?php
								$query = mysql_query("select * from public where client_id = '$session_id'")or die(mysql_error());
   ...
   <script>
			...
			jQuery("#change_password").submit(function(e){
					...
					$.ajax({
						type: "POST",
						url: "update_password_public.php",
						data: formData,
						success: function(html){
					
						$.jGrowl("Your password is successfully change", { header: 'Change Password Success' });
						var delay = 2000;
							setTimeout(function(){ window.location = 'dashboard_public.php'  }, delay);  
