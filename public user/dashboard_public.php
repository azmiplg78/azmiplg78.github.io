				         ...
				         <div class="col-lg-12">
                          <div class="alert alert-success alert-dismissable">
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                             <img id="avatar1" class="img-responsive" src="<?php echo $row['thumbnails']; ?>"><strong> Welcome!</strong> <?php echo $public_row['firstname']." ".$public_row['lastname'];  ?>
                          </div>
                        </div>
                ...
                <div class="row-fluid">				
                    <div class="span6">
                        <div class="panel panel-primary">
                            ...
                            <a href="device_stocks.php?stdev_id=0">							  
