...
<div id="myModal3" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-header">
		...
		<h3 id="myModalLabel">Change Picture of <?php echo $public_row['firstname']." ".$public_row['lastname'];  ?></h3>
	</div>
		<div class="modal-body">
					<form method="post" class="form-horizontal" action="public_user_pic.php" enctype="multipart/form-data">							
