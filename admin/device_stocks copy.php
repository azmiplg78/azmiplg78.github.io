...
?>
		...
		<td><?php
			...
			<td><?php
			  ...
			  <td>	
			   		<?php
							...
							$iddevice = $row['dev_id'];
							$device_query1 = mysql_query("select * from stlocation where stdev_id='$iddevice' ")or die(mysql_error());
							$dev=mysql_fetch_assoc($device_query1);
							echo $dev['stdev_location_name'];
			...
			<!-- <td class="empty" width="80"><a rel="tooltip"  title="Delete Device" id="e<?php echo $id; ?>" href="device_delete.php<?php echo '?id='.$id; ?>" class="btn btn-danger"><i class="icon-trash"> Delete</i></a></td>
			-->
		</tr>
