								...
								<form action="delete_client.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
												...
												<td width="120">
												<a rel="tooltip"  title="Edit Technician" id="e<?php echo $id; ?>" href="edit_client.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"> Edit Info</i></a>
												</td>
