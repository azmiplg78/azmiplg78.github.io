<div class="row-fluid">				  
   <a href="public_user.php" class="btn btn-info" id="add" data-placement="right" title="Click to Add New" ><i class="icon-plus-sign icon-large"></i> Add New Public User</a>
	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-pencil icon-large"></i> Edit Public User Info.</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query = mysql_query("select * from public where client_id = '$get_id'")or die(mysql_error());
...
mysql_query("update public set username = '$username'  , firstname = '$firstname' , lastname = '$lastname', password = '$password' where client_id = '$get_id' ")or die(mysql_error());

mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit Public User $firstname')")or die(mysql_error());	
?>
<script>
  window.location = "public_user.php";
 $.jGrowl("Public User Successfully Update", { header: 'Public User Update' });  
</script>
<?php
}
?>