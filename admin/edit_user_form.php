   <div class="row-fluid">
   <a href="admin_user.php" class="btn btn-info" id="add" data-placement="right" title="Click to Add New Administrator Account" ><i class="icon-plus-sign icon-large"></i> Add New Administrator Account</a>
	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-pencil icon-large"></i> Edit Administrator Account Info</div>
                            </div>
...
mysql_query("update admin set username = '$username'  , firstname = '$firstname' , lastname = '$lastname', password = '$password' where admin_id = '$get_id' ")or die(mysql_error());
...
<script>
  ...
  $.jGrowl("Administrator Account Successfully Update", { header: 'Administrator Account Update' });
</script>
<?php
}
?>