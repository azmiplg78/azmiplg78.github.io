   ...
   <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-plus-sign icon-large"> Add New Administrator Account</i></div>
                            </div>
...
mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Add Administrator $firstname')")or die(mysql_error());
?>
<script>
window.location = "admin_user.php";
$.jGrowl("Adimistrator Successfully added", { header: 'Administrator add' });
</script>
<?php
}
}
