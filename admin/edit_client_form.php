...
mysql_query("update client set username = '$username'  , firstname = '$firstname' , lastname = '$lastname' , password = '$password' where client_id = '$get_id' ")or die(mysql_error());
...
<script>
 ...
 $.jGrowl("Technical Staff Successfully Update", { header: 'TEchnical Staff Update' });  
</script>
<?php
}
?>