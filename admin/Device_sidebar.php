				  ...
				  <img id="admin_avatar" class="img-polaroid" src="<?php echo $row['adminthumbnails']; ?>"></div>
					...
					<li> 
						...
						<li class="active">
                            ...
                            <li class="">
                            <a href="device_stocks.php?stdev_id=0"><i class="icon-chevron-right"></i><i class="icon-desktop"></i> Device / Stocks</a>
                            </li>
						    <li>
					  ...
					  <!------/.* manage I.R.I.S user sidebar*------->	
						<li>						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs2"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;Manage I.R.I.S User
							<div class="muted pull-right"><i class="caret"></i></div></a>					
						    <ul id="bs2" class="collapse">						
                            <li class="">
                            <a href="admin_user.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Administrator</a>
                            </li>                           
						    <li class="">
                            <a href="invent_user.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Inventory Staff</a>
                            </li>
							<li class="">
                            <a href="client_user.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Technical Staff</a>
                            </li>
							<li class="">
                            <a href="public_user.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Public User</a>
                            </li>
						    </ul>
						</li>
