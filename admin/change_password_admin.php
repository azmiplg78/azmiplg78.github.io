            ...
            <div class="row-fluid">
               ...
               <div class="span9" id="content">
                     <div class="row-fluid">
					  ...
					  <div class="alert alert-success"><i class="icon-info-sign"></i> <?php echo $user_row['firstname']." ".$user_row['lastname'];  ?> Please Fill in required details</div>
					
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><i class="icon-user"></i>&nbsp;Change Password of <?php echo $user_row['firstname']." ".$user_row['lastname'];  ?> </div>							 
                            </div>
