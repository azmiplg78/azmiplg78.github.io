					   ...
					   <div class="offset2">
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><i class="icon-user"></i>&nbsp;Change Password of <?php echo $client_row['firstname']." ".$client_row['lastname'];  ?> </div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
  								<div class="alert alert-info"><i class="icon-info-sign"></i> <?php echo $client_row['firstname']." ".$client_row['lastname'];  ?> Please Fill in required details</div>
								<?php
